<!-- page de vue pour le depot d'argent -->
<?php
include "treatmentIndex.php";
            ...
            <main>
                <div class="card card-primary">
                    <div class="card-header">
                        <P>FAIRE UN DEPOT D'ARGENT</P>
                    </div>
                    <form method="POST" action="updateDeposit.php">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Montant à deposer(FCFA)</label>
