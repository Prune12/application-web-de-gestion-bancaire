<!-- cette page permet de recuperer les données ussues du formulaire de retrait et de les mettre à jour dans la base de données -->
<?php
...
if (!empty($_POST)) {
  ...
  if (
    ...
    && !empty($_POST["numero"]) && !empty($_POST["montant"]))
   {
    ...
    // // Préparation de la requête d'insertion dans la table operations
    // $sql = "INSERT INTO operations (compte_id, montant,date_operation) VALUES (:compte_id, :montant,NOW())";
